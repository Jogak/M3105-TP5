...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/TestRunnerTantQue.o ${TESTDIR}/TestTantQue.o ${OBJECTFILES:%.o=%_nomain.o}
...
${TESTDIR}/TestTantQue.o: TestTantQue.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/TestTantQue.o TestTantQue.cpp
